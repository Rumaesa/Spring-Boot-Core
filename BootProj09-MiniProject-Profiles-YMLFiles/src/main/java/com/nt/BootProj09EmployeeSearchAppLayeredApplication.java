...
public class BootProj09EmployeeSearchAppLayeredApplication {

	public static void main(String[] args) {
		  //get the ApplicationContext container
		ApplicationContext ctx=SpringApplication.run(BootProj09EmployeeSearchAppLayeredApplication.class, args);
